...
. /data/vitsGPT/vits/eval_datasets/eval_librif/eval_2_unify_and_eval_init.sh ${method} ${model} ${step} # You only need to run this once. But you can run below scripts many times. 
