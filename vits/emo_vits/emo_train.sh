...
CUDA_VISIBLE_DEVICES=1 python emo_train.py -c configs/ljs_sem_last.json -m ljs_emo_add_last 
...
CUDA_VISIBLE_DEVICES=1 python emo_train.py -c configs/onehour_ljs_sem_ave.json -m onehour_ljs_emo_add_ave 
CUDA_VISIBLE_DEVICES=0 python emo_train.py -c configs/onehour_ljs_sem_last.json -m onehour_ljs_emo_add_last 
CUDA_VISIBLE_DEVICES=1 python emo_train.py -c configs/onehour_ljs_sem_pca.json -m onehour_ljs_emo_add_pca 
CUDA_VISIBLE_DEVICES=0 python emo_train.py -c configs/onehour_ljs_sem_eis_word.json -m onehour_ljs_emo_add_eis_word 
CUDA_VISIBLE_DEVICES=1 python emo_train.py -c configs/onehour_ljs_sem_eis_sentence.json -m onehour_ljs_emo_add_eis_sentence 
