...
# CUDA_VISIBLE_DEVICES=1 python emo_train.py -c configs/ljs_sem_pca.json -m ljs_emo_add_pca
# CUDA_VISIBLE_DEVICES=1 python emo_train.py -c configs/ljs_sem_eis_word.json -m ljs_emo_add_eis_word
