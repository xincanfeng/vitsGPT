...
def get_phoneme_durations(
    ...
    try:
        ...
        logging.warning("Text and audio mismatch detected, skipping this file.")
        return None, None
    ...
    with open(train_text_path, "w") as text_file:
        with open(durations_path, "w") as durations_file:
            ...
            for lab_path in lab_paths:
                ...
                if new_phones is None and durations is None:
                    logging.warning("Text and audio mismatch detected for %s, skipping.", lab_path)
                    continue
